...
<?php
    ...
    require_once(dirname(__FILE__).'/../db-support/First Data API Conversion/check_db.php');
    ...
    if ($resultCount > 1) {
      ...
      $type = $record['fieldData']['Type'];
      	...
      	if (!empty($dateEnd) && ($dateStart != $dateEnd)) { # add condition to display start and end dates next to times as per sketch
                ...
                // JRK: added two divs just before this li to get elements to match...3/25/2020
      } // if show == true		

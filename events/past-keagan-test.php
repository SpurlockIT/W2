  ...
  //findreq2 responsible for adding end dates for exhibits
  $findreq2 = $fm2->newFindRequest('Web_Events');
  $findreq2->addFindCriterion('Date_End_Year', $year);
  $findreq2->addFindCriterion('Date_End_Month', $month);
  $findreq2->addFindCriterion('Type_Primary', 'Exhibit');
                  ...
                  if (FileMaker::isError($result)) {
                    ...
                    foreach($records as $record) {
                      ...
                      if ($show == true) {
                        ...
                        //if event is an exhibit and start date is today
//                        if ($type1 == "Exhibit") {
//                            if (/*if the start date of the exhibit is equal to the selected month on past events */) {
//                                echo "Opening Today";
//                            } else if (/*if the end date of the exhibit is equal to the selected month on past events */) {
//                                echo "Closing Today";
//                            }
//                        }

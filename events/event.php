...
if (isset($_GET['preview'])) {
 ...
 if(check_db("web_events") == 1){
              ...
              foreach ($records as $record){
                  ...
                  $location_NoMap = html_entity_decode($record->getField('Location_NoMap'));
                  ...
                  //if $location includes an a-tag, change $location_NoMap to 'No Map'
                  if (strpos($location, '<a') !== false) {
                      $location_NoMap = 'No Map';
                  }
                  //default timezone for CDT/CST transitions
...
<html class="no-js" lang="en">
    ...
    <?php
     ...
     if(check_db("Website CMS") == 1 && $invalid_id == false){
         ...
         echo' <meta property="og:image" content="https://www.spurlock.illinois.edu/img/'.$photo.'" />';
                  ...
                  // [1/21/2019 DGM] moved breadcrumbs below image, as in blogposts
                    echo'   <div class="row">
                      ...
                      if(!empty($timeStart)) {
                        ...
                        //determines if current time is in daylight savings
                        //sets $zone variable to CDT/CST accordingly
                        ...
                        //for events with only a start date and start time
                        if (empty($timeEnd) && empty($dateEnd)) {
                                echo $timeStart . " " . $zoneEndDisplay . "</li>";
                        } else if(empty($timeEnd)) {
                                echo  $timeStart . " " . $zoneStartDisplay . "</li>";
                        } else if ($checkdayofweekstart != $checkdayofweekend & $checkdayofweekend != 0) {
                                echo $timeStart . " " . $zoneStartDisplay . " " . $dayofweekstart ."&ndash;". $timeEnd . " " . $zoneEndDisplay . " " . $dayofweekend. "</li>";
                        } else if ($zoneStartDisplay == '') {
                                echo $timeStart . $zoneStartDisplay . "&ndash;" . $timeEnd . " " . $zoneEndDisplay . "</li>";
                        } else {
                                echo $timeStart . " " . $zoneStartDisplay . "&ndash;" . $timeEnd . " " . $zoneEndDisplay . "</li>";
                        }
                      ...
                      //v3-Keagan
                      if (!empty($location)){
                        echo '<li class="location" title="Location"><span class="visuallyhidden">Location: </span>';
                        if(!empty($location_NoMap)){
                          echo $location;
                          //for future developments, change to'elseif' in case more fields are added
                        } else {
                          echo '<a class="external" href="http://maps.google.com/?q='.urlencode($location).'">' . $location . '</a>';
                        }
                        echo '</li>';
                      }
                    ...
                    if(!empty($infolink1)){
                                ...
                                if(!empty($contactName)) {
                                  ...
                                  if(empty($contactEmail)) {
                                    echo "<p>For further information on this event, contact <strong>" . $contactName . " </strong>at <a class='phone' href='tel:" . $contactPhone . "'>" . $contactPhone . "</a>.</p>";
                                  }
                                  ...
                                  echo "<p>For further information on this event, contact <strong>" . $contactName . " </strong>at <a class='email' href='mailto:" . $contactEmail . "'>" . $contactEmail . "<span> (email link)</span></a> or <a class='phone' href='tel:" . $contactPhone . "'>" . $contactPhone . "</a> </p>";
                                  }
                                  ...
                                  echo'   <p>To request disability-related accommodations for this event, please contact <a href="/contact/#brian">Brian Cudiamat</a> at <a class="email" href="mailto:cudiamat@illinois.edu">cudiamat@illinois.edu<span> (email link)</span></a> or <a class="phone" href="tel:2172445586">(217) 244-5586</a>.</p>
                                        </div>
                                      </div>
                                    </section>';
                              }
                              ...
                              elseif(!empty($contactCustomBlock)){
                               echo '
                                ...
                                echo'
                                        <p>To request disability-related accommodations for this event, please contact <a href="/contact/#brian">Brian Cudiamat</a> at <a class="email" href="mailto:cudiamat@illinois.edu">cudiamat@illinois.edu<span> (email link)</span></a> or <a class="phone" href="tel:2172445586">(217) 244-5586</a>.</p>
                                        </div>
                                      </div>
                                    </section>';
...
<aside id="related-sequence" class="full-width-band purple-2" <?php if($published != "Yes" || strtotime($date_publish) > time()) echo 'style="display:none" ';?> >
  <div class="row">
    <div class="small-12 columns">
